    ...
    var NivoSlider = function(element, options){
        ...
        var createSlices = function(slider, settings, vars){
          ...
          if ( $.browser.msie && parseInt($.browser.version, 10) <= 8 ) {
            var filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled='true',sizingMethod='crop',src='" + vars.currentImage.attr('src') + "')"
          } else {
            var bg = 'url("'+ vars.currentImage.attr('src') +'") no-repeat -'+ ((sliceWidth + (i * sliceWidth)) - sliceWidth) +'px 0%';
          }
					slider.append(
						$('<div class="nivo-slice"></div>').css({
